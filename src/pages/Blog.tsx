  ...
  const blogData = [
    {
      ...
      summary: "Learn how to structure your resume to pass modern ATS systems using keywords, formatting, and structure best practices.",
      readTime: "3 min read",
    ...
    },
    {
      ...
      summary: "Explore the latest AI tools that optimize your job search, from email writing to instant job matches.",
      readTime: "5 min read",
    ...
    },
    {
      ...
      summary: "Discover proven frameworks and examples that get responses when emailing hiring managers and recruiters.",
      readTime: "4 min read",
    ...
    },
    {
      ...
      summary: "Learn the importance of customizing your resume for each job description to increase your chances of getting shortlisted.",
      readTime: "5 min read",
        ...
        <div className={`flex-1 bg-gray-50 ${showSideBar?"h-screen":"ml-20 h-screen md:ml-0 "}`}>
          <div className="p-6">
              ...
              <div className='text-sm text-gray-600 pl-3'>
                Stay updated with the best practices in resumes, emails, and job search strategy.
              </div>
              <div className='grid grid-cols-1 md:grid-cols-2 md:grid-rows-2 grid-rows-1 gap-4  p-3'>
                  
                    {blogData.map((data,index)=>(
                      <a className='flex flex-col shadow-md rounded bg-white p-2 curosr-pointer ' key={index} href={data.ref} target="_blank">
